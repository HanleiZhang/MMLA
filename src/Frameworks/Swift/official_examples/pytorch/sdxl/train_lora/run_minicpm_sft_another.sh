...
train_datasets=("/root/autodl-tmp/wpw/new_ft_cpm-v/video_prompt_data/MELD/train.jsonl")
eval_datasets=("/root/autodl-tmp/wpw/new_ft_cpm-v/video_prompt_data/MELD/dev.jsonl")
...
for index in ${!train_datasets[@]}; do
    ...
    CUDA_VISIBLE_DEVICES=0,1,2,3 NPROC_PER_NODE=4 swift sft \
      ...
      --eval_batch_size 1 \
      --deepspeed default-zero2 \
      --output_dir /root/autodl-tmp/model/wpw/output/minicpm_MELD \
