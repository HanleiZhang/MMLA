...
train_datasets=("/root/autodl-tmp/wpw/swift/video_prompt_data/Ch-sims/train.jsonl")
eval_datasets=("/root/autodl-tmp/wpw/swift/video_prompt_data/Ch-sims/dev.jsonl")
...
for index in ${!train_datasets[@]}; do
    ...
    CUDA_VISIBLE_DEVICES=0 NPROC_PER_NODE=1 swift sft \
      ...
      --save_steps 10000 \
      --eval_batch_size 1 \
      --output_dir /root/autodl-tmp/wpw/swift/output/${dataset_name}_1 \
