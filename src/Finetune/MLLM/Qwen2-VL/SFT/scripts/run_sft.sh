...
WORK_PATH="$BASE_PATH/MMLA/src/Finetune/MLLM/Qwen2-VL/SFT"
...
MODEL_NAMES=("Qwen2-VL-72B-Instruct" "Qwen2-VL-7B-Instruct") 
...
for MODEL_NAME in "${MODEL_NAMES[@]}"; do
    ...
    for dataset in "${!task_map[@]}"; do
        ...
        train_config="${TRAIN_LORA_PATH}/${DATASET_NAME}_${TASK_NAME}_${MODEL_NAME}.yaml"
        ...
        if [ "$MODEL_NAME" == "Qwen2-VL-72B-Instruct" ]; then
